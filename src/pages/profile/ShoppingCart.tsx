    ...
    return (
        <>
                ...
                <div>
                    <div className="acc-box p-3 p-md-4">
                        <div className="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div className="text-sm-end color-1 mt-2 mt-sm-0 ms-sm-4">
                                Стоимость: <span className="fw_9">{FunctionForPrice(12314125)}&nbsp;₽</span>
                            </div>
                        </div>
                        <button type="button" className="btn_main btn_2 f_09 mt-3">
                            Убрать
                        </button>
                    </div>
                </div>
            ...
            <div className="acc-box p-3 p-md-4 d-md-flex align-items-center">
                ...
                <div className="color-1 mt-3 mt-md-0 ms-md-4">
                    Стоимость: <span className="fw_9">{FunctionForPrice(12314125)}&nbsp;₽</span>
                </div>
                <button type="button" className="btn_main btn_1 f_09 mt-3 mt-md-0 ms-md-4">
                    Оплатить
                </button>
            </div>
            ...
            <div className="row row-cols-sm-2 gy-2 gx-sm-4 gx-xl-5 gy-sm-4">
                <div>
                    <div className="acc-box p-3 p-md-4">
                        ...
                        <button type="button" className="btn_main btn_1 f_09 mt-3">
                            Добавить
                        </button>
                    </div>
                </div>
